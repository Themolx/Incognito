...
def replace_clip_name(item):
    """Add a marker with the product name and version to the clip."""
    try:
        ...
        # Append version marker "_v001" to the product name
        product_name += "_v001"
        ...
        try:
            ...
            # Add a marker with the product name and version
